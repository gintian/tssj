  ...
  <el-row class="container">
    ...
    <el-col :span="24" class="topbar-wrap">
      ...
      <div class="topbar-logos">
        <h1 style="color: #fff;padding-left: 20px; font-weight: 100;">
          <span v-show="!$store.state.collapsed">态势数据关联分析平台</span>
        </h1>
      </div>
      ...
      <div class="topbar-account topbar-btn">
        <div>
          <img src="../assets/images/user.png" style="position: relative; top: 5px;left: -4px;" /> ZHOUJUENAN
        </div>
        <div @click="logout()">
          <img src="../assets/images/logout.png" style="position: relative; top: 5px;left: -10px;" />退出
        </div>
      </div>
    </el-col>
